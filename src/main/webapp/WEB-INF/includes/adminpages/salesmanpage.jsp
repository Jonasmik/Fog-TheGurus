        ...
        <div class="col-lg-9 col-md-8">
            <div class="tab-content" id="v-pills-tabContent">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <c:if test="${activepreorder.shed.length > 0}">
                                                            <h5>Skur</h5>
                                                            <p>
                                                                Bredde: ${activepreorder.shed.width}</p>
                                                            <p>
                                                                Længde: ${activepreorder.shed.length}</p>
                                                        </c:if>
                                                    </div>
                ...
                <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                    ...
                    <c:if test="${empty requestScope.unusedpreorders}">
                        <p>Der er ikke nogle tilgængelige forespørgelser</p>
                    </c:if>

                    <c:if test="${not empty requestScope.unusedpreorders}">
                        <div class="table-responsive">
                            <table class="table table-bordered">
                                <thead>
                                <tr>
                                ...
                                <c:forEach var="unusedpreorder"
                                           items="${requestScope.unusedpreorders}">
                                    <form action="Main" method="POST">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <c:if test="${unusedpreorder.shed.length > 0}">
                                                            <h5>Skur</h5>
                                                            <p>
                                                                Bredde: ${unusedpreorder.shed.width}</p>
                                                            <p>
                                                                Længde: ${unusedpreorder.shed.length}</p>
                                                        </c:if>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <button type="button"
                                                        ...
                                                        <button type="submit"
                                                                class="btn btn-outline-primary">Tag
                                                            som
                                                            kunde
                                                        </button>
                                                    </div>

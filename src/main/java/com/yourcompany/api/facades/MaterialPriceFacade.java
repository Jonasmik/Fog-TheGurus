...
public class MaterialPriceFacade {
    ...
    public Bom createList(MaterialRepository materialRepository, Carport carport, Shed shed)
    ...
    public double findPrice(LumberType trykimpBrædt, int lenght, int amount) {
        MaterialPrice material = null;
        try {
            material = repo.findByName(String.valueOf(trykimpBrædt));
    ...
    private int calculateWood(int number) {

...
public class CarportTopView {
    ...
    private static void createRims(Svg carportTopView, int xspacing, int yspacing, int lengthmm,
            int widthmm) {
        // rem
    ...
    private static void createRafters(Svg carportTopView, int lengthmm, int xspacing, int yspacing,
            int widthmm) {
        // Spær afstand
    ...
    private static void createStandardPosts(Svg carportTopView, int yspacing, int xspacing,
        ...
        double calculateMiddlePost =
                ((xspacing + lengthmm - 275 - (postWidth / 2)) - (upToFirstPost)) / 2
                        + upToFirstPost;
        ...
        Tag topRightPost = new Rect(xspacing + lengthmm - 275 - (postWidth / 2), yspacing + 350,
                postWidth, postWidth);
        ...
        Tag bottomLeftPost = new Rect(upToFirstPost, yspacing + widthmm - 350 - postWidth,
                postWidth, postWidth);
        Tag bottomRightPost = new Rect(xspacing + lengthmm - 275 - (postWidth / 2),
                yspacing + widthmm - 350 - postWidth, postWidth, postWidth);
        carportTopView
                .add(bottomLeftPost.withStyle("fill: white; stroke: black; stroke-width: 10;"));
        carportTopView
                .add(bottomRightPost.withStyle("fill: white; stroke: black; stroke-width: 10;"));

        if (lengthmm >= minLengthThirdPost) {
            Tag topMiddlePost = new Rect(calculateMiddlePost, yspacing + 350, postWidth, postWidth);
            Tag bottomMiddlePost = new Rect(calculateMiddlePost,
                    yspacing + widthmm - 350 - postWidth, postWidth, postWidth);
            carportTopView
                    .add(topMiddlePost.withStyle("fill: white; stroke: black; stroke-width: 10;"));
            carportTopView.add(bottomMiddlePost
                    .withStyle("fill: white; stroke: black; stroke-width: 10;"));
        }

    }

    private static void createArrowLines(Svg carportTopView, int xspacing, int yspacing,
        ...
        Tag lineStopBottomInnerLeft = new Line(500, yspacing + widthmm - 350, 900,
                yspacing + widthmm - 350);
        Tag leftLengthInnerText = new Text(850, yspacing + (widthmm / 2), "black", 200,
                "rotate(-90 850, " + halfWidth + ")", +width - 70.0 + " cm");
        carportTopView.add(leftInnerLengthMeasure.withStyle(
                "stroke: black; stroke-width: 10; marker-start: url(#beginArrow); marker-end: url(#endArrow)"));
    ...
    private static void createShed(Svg carportTopView, int xspacing, int yspacing, int lengthmm,
        ...
        Tag lineAround = new Rect(
                (xspacing + lengthmm - 275 - shedLengthMM + (pillarWidth / 2)) - 20,
                yspacing + 350 - 20, shedLengthMM + 40, shedWidthMM + 40);
        carportTopView.add(lineAround.withStyle(
                "fill: white; stroke-dasharray: 100 100; stroke: black; stroke-width: 10;"));

        Tag topShedShedding = new Rect(xspacing + lengthmm - 275 - shedLengthMM + (pillarWidth / 2),
                yspacing + 350, shedLengthMM, 45);
        Tag bottomShedShedding = new Rect(
                xspacing + lengthmm - 275 - shedLengthMM + (pillarWidth / 2),
                yspacing + shedWidthMM + 350 - 45, shedLengthMM, 45);
        Tag leftShedShedding = new Rect(
                xspacing + lengthmm - 275 - shedLengthMM + (pillarWidth / 2), yspacing + 350, 45,
                shedWidthMM);
        Tag rightShedShedding = new Rect(xspacing + lengthmm - 275, yspacing + 350, 45,
                shedWidthMM);
        carportTopView
                .add(topShedShedding.withStyle("fill: white; stroke: black; stroke-width: 20;"));
        carportTopView
                .add(bottomShedShedding.withStyle("fill: white; stroke: black; stroke-width: 20;"));
        carportTopView
                .add(leftShedShedding.withStyle("fill: white; stroke: black; stroke-width: 20;"));
        carportTopView
                .add(rightShedShedding.withStyle("fill: white; stroke: black; stroke-width: 20;"));


    }

    private static void createShedPosts(Svg carportTopView, int xspacing, int yspacing,
            int lengthmm, int widthmm, int shedLengthMM, int shedWidthMM, int postWidth) {
        ...
        Tag leftBottomPost = new Rect(upToFirstShedPost, yspacing + shedWidthMM + 350 - 90,
                postWidth, postWidth);
        carportTopView
                .add(leftBottomPost.withStyle("fill: white; stroke: black; stroke-width: 10;"));
        ...
        if (doesNotNeedBottomRightPost) {
            Tag rightBottomPost = new Rect(xspacing + lengthmm - 275 - (postWidth / 2),
                    yspacing + shedWidthMM + 350 - 90, postWidth, postWidth);
            carportTopView
                    .add(rightBottomPost.withStyle("fill: white; stroke: black; stroke-width: 10"));
        }

        boolean needsAThirdPost = shedWidthMM >= minLengthThirdPost;
        if (needsAThirdPost) {
            Tag leftMiddlePost = new Rect(upToFirstShedPost, calculateMiddlePost, postWidth,
                    postWidth);
            Tag rightMiddlePost = new Rect(upToFirstShedPost + shedLengthMM - postWidth,
                    calculateMiddlePost, postWidth, postWidth);
            carportTopView
                    .add(leftMiddlePost.withStyle("fill: white; stroke: black; stroke-width: 10;"));
            carportTopView.add(rightMiddlePost
                    .withStyle("fill: white; stroke: black; stroke-width: 10;"));
        }
    }

    private static void createXSupport(Svg carportTopView, int xspacing, int yspacing, int lengthmm,
            int widthmm) {
        // Spær afstand
        ...
        if (canCreatePerfectSquare) {
            Tag topLeftX = new Line(xspacing + 550, yspacing + 350, xspacing + 550 + widthmm - 700,
                    yspacing + widthmm - 350);
            Tag topRightX = new Line(xspacing + 550 + widthmm - 700, yspacing + 350, xspacing + 550,
                    yspacing + widthmm - 350);
            carportTopView.add(topLeftX
                    .withStyle("stroke-dasharray: 70 70; stroke-width: 20; stroke: black;"));
            carportTopView.add(topRightX
                    .withStyle("stroke-dasharray: 70 70; stroke-width: 20; stroke: black;"));
        } else {
            Tag topLeftX = new Line(xspacing + 550, yspacing + 350,
                    xspacing + (calculateAmountOfRafters * (550 + calculateExtraRaftersSpace)),
                    yspacing + widthmm - 350);
            Tag topRightX = new Line(
                    xspacing + (calculateAmountOfRafters * (550 + calculateExtraRaftersSpace)),
                    yspacing + 350, xspacing + 550, yspacing + widthmm - 350);
            carportTopView.add(topLeftX
                    .withStyle("stroke-dasharray: 70 70; stroke-width: 20; stroke: black;"));
            carportTopView.add(topRightX
                    .withStyle("stroke-dasharray: 70 70; stroke-width: 20; stroke: black;"));
    ...
    public static void main(String[] args) {
        ...
        try (FileWriter writer = new FileWriter("output.svg")) {
            writer.write(carportTopView(420, 630, 330, 210).toString());
        } catch (IOException e) {
            e.printStackTrace();
        }
    }

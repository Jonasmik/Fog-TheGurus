...
public class User {
    ...
    public static byte[] calculateSecret(byte[] salt, String password) throws UserValidationError {
    ...
    public boolean isPasswordCorrect(String password) throws UserValidationError {
